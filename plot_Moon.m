...
RE_eq = 1738.1; %[km] Earth equatorial radius (WGS 84)
RE_pol = 1736; %[km] Earth polar radius (WGS 84)
...
gh = surf(Earthx+3.8475e5,Earthy,-Earthz,'FaceColor','texturemap','CData',cdata, ...
    'EdgeColor','none');
axis equal