function out = gmos_init_mu_branch_from_jpl( ...
...
%   out.po           : seed PO data
    ...
    % Use the PO Jacobi constant as the fixed-C target
    Ctarget = Jacobi_Constant(xPO0.', muSeed);

    % ------------------------------------------------------------
    % Build two nearby GMOS seeds at the same mu and correct them at fixed C
    % ------------------------------------------------------------
    ...
    [z0_sol, info0] = gmos_newton_fixC_analytic( ...
        z0, N, muSeed, Xref, Tref, rhoref, Ctarget, ode_opts, optsNewton);

    [Xref1, Tref1, rhoref1] = gmos_unpack_z(z0_sol, N);

    [z1_sol, info1] = gmos_newton_fixC_analytic( ...
        z1, N, muSeed, Xref1, Tref1, rhoref1, Ctarget, ode_opts, optsNewton);
