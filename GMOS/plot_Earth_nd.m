function [gh] = plot_Earth_nd(npts,GST, c)
...
RE_eq =  c*6378.137/384400; %[nd] Earth equatorial radius (WGS 84)
RE_pol = c*6356.7521736/  384400; %[nd] Earth polar radius (WGS 84)
